...
public class OnlineSkillManager : MonoBehaviour
{
    ...
    public void UseSkill(OnlineGameManager.SkillType skillType)
    {
        Debug.Log("UseSkill called");
        Debug.Log("skillType: " + skillType);
        switch (skillType)
        {
            case OnlineGameManager.SkillType.Scan: StartCoroutine(ScanSkill()); break;
            case OnlineGameManager.SkillType.Change: ChangeSkill(); break;
            case OnlineGameManager.SkillType.Obstruct: StartCoroutine(ObstructSkill()); break;
            case OnlineGameManager.SkillType.FakeOut: FakeOutSkill(); break;
            case OnlineGameManager.SkillType.Copy: CopySkill(); break;
        }
    }
